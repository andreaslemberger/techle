...
describe("Tile", () => {
  ...
  it("renders empty tile with no letter", () => {
    const { container } = render(
      <Tile letter="" state="empty" reveal={false} delay={0} />
    );
  ...
  it("applies filled class when letter is present", () => {
    const { container } = render(
      <Tile letter="R" state="empty" reveal={false} delay={0} />
    );
  ...
  it("applies correct class when revealed", () => {
    const { container } = render(
      <Tile letter="R" state="correct" reveal={true} delay={0} />
    );
  ...
  it("applies present class when revealed", () => {
    const { container } = render(
      <Tile letter="R" state="present" reveal={true} delay={0} />
    );
  ...
  it("applies absent class when revealed", () => {
    const { container } = render(
      <Tile letter="R" state="absent" reveal={true} delay={0} />
    );
  ...
  it("does not apply state class when not revealed", () => {
    const { container } = render(
      <Tile letter="R" state="correct" reveal={false} delay={0} />
    );
  ...
  it("applies animation delay when revealed", () => {
    const { container } = render(
      <Tile letter="R" state="correct" reveal={true} delay={600} />
    );
